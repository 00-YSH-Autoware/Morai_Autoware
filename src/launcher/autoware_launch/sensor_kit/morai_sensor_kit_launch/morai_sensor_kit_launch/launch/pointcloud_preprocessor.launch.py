# MORAI 포인트클라우드 전처리(self/mirror crop → concatenated relay) 런치 — carla 패턴 차용
"""Pointcloud preprocessor launch for MORAI sensor kit."""
...
def launch_setup(context, *args, **kwargs):
    """Configure MORAI pointcloud preprocessing with ego vehicle filtering."""
    nodes = []
...
def generate_launch_description():
    """Generate launch description for MORAI pointcloud preprocessing."""
    launch_arguments = []
    ...
    add_launch_arg(
        ...
        PathJoinSubstitution(
            [
                FindPackageShare("morai_sensor_kit_launch"),
                "config",
                "mirror.param.yaml",
            ]
        ),
